...
export const socials = [
  {
    ...
    url: 'https://x.com/MaxSM117',
  },
  {
    id: '1',
    title: 'LN',
    icon: '/images/socials/lnd.svg',
    url: 'https://getalby.com/p/maxsm',
  },
  {
    id: '2',
    title: 'Instagram',
    icon: '/images/socials/instagram.svg',
    url: 'https://www.instagram.com/maxsm117/',
  },
  {
    id: '3',
    title: 'Github',
    icon: '/images/socials/github2.svg',
    url: 'https://github.com/Starklord17',
  },
  {
    id: '4',
    title: 'Discord',
    icon: '/images/socials/link.svg',
    url: 'https://linkr.bio/maxsm',
  },
];